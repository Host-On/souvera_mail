...
(function () {
	...
	*/
	...
	//			+ b64EncodeJSONSafe(url.replace(/ /g, '%20')),
		...
		themePreviewLink = theme => {
			if (theme.endsWith('@nextcloud')) {
				...
				return parent.OC.webroot + '/themes/' + encodeURI(theme) + '/smail/preview.png';
			}
	...
	const
		...
		// see /smail/v/0.0.0/app/localization/relativetimeformat/
	...
	const
		errorTip = (element, value) => value
				? setTimeout(() => element.setAttribute('data-smailErrorTip', value), 100)
				: element.removeAttribute('data-smailErrorTip'),
	...
	*/
	...
	const contentType = 'smail/emailaddress',
			...
			"uids": [
				{
					"name": "demo",
					"comment": "",
					"email": "demo@smail.dev",
					"uid": "demo <demo@smail.dev>",
					"revoked": false,
					"invalid": false
				}
			],
...
<body></body>
	...
	*/
	...
	const rlContentType = 'smail/action',
