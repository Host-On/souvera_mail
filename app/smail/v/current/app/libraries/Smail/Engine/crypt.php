...
abstract class Crypt
{
	...
	) /* : mixed */
	{
		...
		return static::Decrypt(\array_map('Smail\Mail\\Base\\Utils::UrlSafeBase64Decode', $data), $key);
	}
...
*/
	...
	{
		return \implode('.', \array_map('Smail\Mail\\Base\\Utils::UrlSafeBase64Encode', static::Encrypt($data, $key)));
	}
	...
	) /* : mixed */
	{
		...
		return \is_callable('xxtea_decrypt')
			...
			: \Smail\Mail\Base\Xxtea::decrypt($data, $key);
	}
	...
	) : string
	{
		...
		$result = \is_callable('xxtea_encrypt')
			...
			: \Smail\Mail\Base\Xxtea::encrypt($data, $key);
		if (!$result) {
...
\Smail\Engine\Crypt::setCipher(\Smail\Engine\Api::Config()->Get('security', 'encrypt_cipher', 'aes-256-cbc-hmac-sha1'));
