...
class Certificate
{
	...
	public function createSelfSigned(\Smail\Engine\SensitiveString $passphrase, ?string $privateKey = null) : array
	{
		$options = array(
			...
			// End-entity S/MIME cert (CA:FALSE, emailProtection). Never smail_ca:
			// user certs must not be CAs, and there is no shared CA to sign them.
			'x509_extensions'    => 'smail_req',
			// Extensions to add to a certificate request
			'req_extensions'     => 'smail_req', // v3_req
		);
