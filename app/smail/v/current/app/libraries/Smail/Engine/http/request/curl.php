...
namespace Smail\Engine\HTTP\Request;

use Smail\Engine\HTTP\Response;

class CURL extends \Smail\Engine\HTTP\Request
{
	private
...
//		\curl_setopt($c, CURLOPT_ENCODING , 'gzip');
		...
		if ($this->block_private && \defined('CURLOPT_RESOLVE')) {
			$pin = \Smail\Engine\HTTP\Ssrf::pin($request_url);
			if ($pin) {
