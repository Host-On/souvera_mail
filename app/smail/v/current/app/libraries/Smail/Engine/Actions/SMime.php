...
use Smail\Engine\SMime\OpenSSL;
use Smail\Engine\SMime\Certificate;
...
trait SMime
{
	...
	public function DoSMimeExportPrivateKey() : array
	{
		...
		$SMIME->setPrivateKey(
			...
			new \Smail\Engine\SensitiveString($this->GetActionParam('oldPassphrase', ''))
		);
		$result = $SMIME->exportPrivateKey(
			new \Smail\Engine\SensitiveString($this->GetActionParam('newPassphrase', ''))
		);
