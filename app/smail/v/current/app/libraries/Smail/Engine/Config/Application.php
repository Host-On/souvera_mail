...
namespace Smail\Engine\Config;

class Application extends \Smail\Engine\Config\AbstractConfig
{
...
; Please don\'t add custom parameters here, those will be overwritten',
	...
	public function Load() : bool
	{
		...
		if (!$sCipher || !\Smail\Engine\Crypt::cipherSupported($sCipher)) {
			$sCipher && \Smail\Engine\Log::warning('Crypt', "OpenSSL no support for cipher '{$sCipher}'");
			$aCiphers = \Smail\Engine\Crypt::listCiphers();
	...
	public function Set(string $sSectionKey, string $sParamKey, $mParamValue) : void
	{
		...
		if ('language' === $sParamKey) {
			$mParamValue = \Smail\Engine\L10n::validLanguage($mParamValue, false) ?: 'en';
		}
	...
	protected function defaultValues() : array
	{
		...
		return array(
			...
			'webmail' => array(
				...
				'title'                       => array('Smail', 'Text displayed as page title'),
				'loading_description'         => array('Smail', 'Text displayed on startup'),
				'favicon_url'                 => array(''),
				'app_path'                    => array(''),

				'theme'                       => array('smail', 'Theme used by default'),
...
Warning: only enable when server does not do this, else double compression errors occur')
			...
			'security' => array(
				'custom_server_signature' => array('Smail'),
				...
				'csp_report'              => array(false, 'Report CSP errors to PHP and/or Smail Log'),
