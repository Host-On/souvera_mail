...
namespace Smail\Mail\Cache\Drivers;
 ...
 * @subpackage Drivers
 */
class File implements \Smail\Mail\Cache\DriverInterface
{
	...
	function __construct(string $sCacheFolder)
	{
		...
		\Smail\Mail\Base\Utils::mkdir($this->sCacheFolder);
	...
	{
		\Smail\Mail\Base\Utils::RecTimeDirRemove($this->sCacheFolder, 3600 * $iTimeToClearInHours);
		return true;
	}
