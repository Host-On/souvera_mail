...
//	public bool $tls_weak = false;
	...
	{
		$value = \Smail\Engine\IDN::emailToAscii($value);
//		$value = \Smail\Engine\IDN::emailToAscii(\Smail\Mail\Base\Utils::Trim($value));
	...
	public static function fromArray(array $aSettings) : self
	{
		...
		$object->type = $aSettings['type'] ?? $aSettings['secure'] ?? \Smail\Mail\Net\Enumerations\ConnectionSecurityType::AUTO_DETECT->value;
