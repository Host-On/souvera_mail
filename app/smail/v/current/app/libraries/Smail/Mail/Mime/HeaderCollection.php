 ...
 * @package Mime
 */
class HeaderCollection extends \Smail\Mail\Base\Collection
{
	 ...
	 * spf=pass (ORIGINATING: domain of "smail@domain.tld" designates 0.0.0.0 as permitted sender) smtp.mailfrom="smail@domain.tld";
