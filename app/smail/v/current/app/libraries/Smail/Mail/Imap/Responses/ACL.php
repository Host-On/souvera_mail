...
namespace Smail\Mail\Imap\Responses;
...
class ACL implements \JsonSerializable
{
	...
	public function hasRight(string|\Smail\Mail\Imap\Enumerations\FolderACL $right) : bool
	{
		if ($right instanceof \Smail\Mail\Imap\Enumerations\FolderACL) {
			return \str_contains($this->rights, $right->value);
		}
		$enum = \Smail\Mail\Imap\Enumerations\FolderACL::tryFrom($right);
