 ...
 *  - appinfo/routes.php exactly 20 routes incl. settings#index
...
assertTrue($routeCount === 20, "routes.php registers exactly 20 routes (got: $routeCount)", $passes, $failures);
