 ...
 *  - appinfo/routes.php exactly 24 routes incl. settings#index (v0.14.37 added sieveApply)
...
// ============================================================
// 5. templates/settings.php DELETED in 0.13.6 — the in-app settings
...
assertTrue($routeCount >= 28, "routes.php registers >= 28 routes (got: $routeCount) — grows over time as features land (v0.15.0 external/*, v0.17.0 /embed, …)", $passes, $failures);
...
// ============================================================
// 8. SettingsController — REDIRECT in 0.13.6 (was TemplateResponse)
// ============================================================
...
// 0.13.6: quota pill now navigates to the in-engine Settings tab (same tab)
...
// ============================================================
// 13. js/personal-settings.js DELETED in 0.13.6 — its logic was ported
