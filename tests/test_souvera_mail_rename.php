...
assertTrue(($vm[1] ?? '') === '0.13.3', "info.xml <version> == 0.13.3 (got: '".($vm[1]??'')."')", $passes, $failures);
...
// ============================================================
// 5. templates/settings.php DELETED in 0.13.3 — the in-app settings
...
// ============================================================
// 8. SettingsController — REDIRECT in 0.13.3 (was TemplateResponse)
// ============================================================
...
// 0.13.3: quota pill now navigates to the in-engine Settings tab (same tab)
...
// ============================================================
// 13. js/personal-settings.js DELETED in 0.13.3 — its logic was ported
