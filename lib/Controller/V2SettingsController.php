...
class V2SettingsController extends Controller
{
    ...
    public function preferences(): JSONResponse
    {
        ...
        return new JSONResponse([
            ...
            'listOnlyLayout' => $this->getPref($uid, 'pref_list_only', '0') === '1',
            'focusLayout' => $this->getPref($uid, 'pref_focus_layout', '0') === '1',
    ...
    public function updatePreferences(): JSONResponse
    {
        ...
        $allowed = [
            ...
            'listOnlyLayout' => 'pref_list_only',
            'focusLayout' => 'pref_focus_layout',
